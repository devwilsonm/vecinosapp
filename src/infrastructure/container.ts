...
module.exports = { allocationRepository, buildingRepository, dashboardRepository, occupantRepository, paymentRepository, publicAllocationRepository, receiptRepository, reportRepository, roleRepository, userRepository };