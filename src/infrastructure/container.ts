...
module.exports = { allocationRepository, buildingRepository, dashboardRepository, occupantRepository, paymentRepository, publicAllocationRepository, publicReportRepository, receiptRepository, reportRepository, roleRepository, userRepository };